...
const CartItem = ({lp}:CartItemProps) => {
    ...
    return <div className="flex items-center p-4 border-b border-gray-200">
        <img src={lp.img} alt={`${lp.title}의 LP 이미지`} className="w-20 h-20
        ...
        <div className="flex items-center">
            <button onClick={handlDecreaseCount} className="px-3 py-1 bg-gray-300 text-gray-800 rounded-l hover:bg-gray-400 cursor-pointer">
                -
            </button>
