    ...
    <div className="min-h-screen bg-white text-slate-900 flex flex-col font-sans">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6">
        <div className="w-full max-w-95">
          ...
          <button className="w-full flex items-center justify-center gap-3 border border-slate-200 rounded-xl py-3.5 mb-8 hover:bg-slate-50 transition-all shadow-sm">
          ...
          <p className="mt-8 text-center text-sm text-slate-500">
            계정이 없으신가요? <span className="text-blue-600 font-semibold cursor-pointer hover:underline">회원가입</span>
          </p>
        </div>
      </main>
    </div>
