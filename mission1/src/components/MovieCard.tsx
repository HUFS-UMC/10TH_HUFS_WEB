...
const MovieCard = ({ movie, onClick }: MovieCardProps) => {
  console.log("MovieCard 렌더:", movie.title);
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className="overflow-hidden rounded-2xl bg-white text-left shadow-md transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
    >
