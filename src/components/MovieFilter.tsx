...
import type { MovidLanguage, MovieFilters } from "../types/movie";
...
const MovieFilter =({onChange}: MovieFilterProps) => {
    ...
    const [language, setLanguage] = useState<MovidLanguage>("ko-KR");
        ...
        p-6 shadow-xl transition-all hover:shadow-2xl">
            <div className="flex flex-wrap gap-6">
                ...
                <div className="min-w-[250px] flex-1">
                    ...
                    <SelectBox checked={includeAdult} onChange={setIncludeAdult} label="성인 콘텐츠 표시" id="include_adult" 
                    className="w-full rounded-lg border border-gray-300 px-4 py-2 shadow-sm
                    focus:outline-none focus:ring-2 focus:ring-blue-500"></SelectBox>
                </div>
                ...
                <LanguageSelector
                value = {language}
                onChange={(val) => setLanguage(val as MovidLanguage)}
