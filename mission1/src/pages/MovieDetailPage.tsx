        ...
        <div className="text-white">
            ...
            >
                ...
                <div className="relative z-10 p-10 max-w-4xl">
                    ...
                    <div className="flex flex-wrap gap-4 mt-3 text-sm text-gray-300 items-center"> {/* 조건에 있던 것처럼 조금 꾸미면서 평점, 년도, 러닝타임, 감독을 데려옴 */}
            ...
            <div className="px-10 py-10">
                ...
                <div className="flex gap-4 overflow-x-auto pb-4"> {/* 출연진을 위에서부터 20명만 데려옴 */}
                    {credits.cast.slice(0, 20).map((actor) => (
                        ...
                        >
                            <img
                                src={
                                    actor.profile_path //이미지가 있으면 그 이미지를 데려오고 없으면 자리 비워둠
