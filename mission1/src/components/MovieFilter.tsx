...
const MovieFilter = ({ onChange }: MovieFilterProps) => {
  ...
  return (
    <form
      ...
      className="rounded-3xl border border-gray-200 bg-white p-8 shadow-lg space-y-8"
    >
      <div className="flex flex-wrap gap-6">
        ...
        <div className="w-full">
          <button
            type="submit"
            className="w-full rounded-xl bg-blue-500 py-4 text-lg font-semibold text-white transition-all duration-300 hover:bg-blue-600"
          >
            🔍 검색하기
          </button>
        </div>
